...
public class InitServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        auctionManager.addAuctionItem(new AuctionItem("1", "Gaming Laptop", "A powerful laptop designed for professionals and gamers, featuring top-tier performance, premium build quality, and cutting-edge specs. Ideal for multitasking, creative work, and smooth gameplay.", 280000 , 280000 , "img/lap.jpeg", LocalDateTime.now().plusHours(3)));
        auctionManager.addAuctionItem(new AuctionItem("2", "Vintage Rolex Watch", "A timeless classic from Rolex, this vintage watch showcases elegant craftsmanship and enduring style. Perfect for collectors or those who appreciate luxury heritage.", 350000, 350000, "img/watch.jpg", LocalDateTime.now().plusHours(2)));
        ...
        auctionManager.addAuctionItem(new AuctionItem("5", "Diamond Engagement Ring", "A stunning diamond engagement ring featuring brilliant-cut stones set in a timeless design. An elegant symbol of love and commitment, crafted to sparkle for a lifetime.", 250000 , 250000, "img/ring.jpg", LocalDateTime.now().plusHours(33)));
        ...
        auctionManager.addAuctionItem(new AuctionItem("11", "Hand-Carved Teak Wood Armchair", "A luxurious armchair made from solid teak wood, featuring intricate hand-carved designs. Combines comfort with traditional craftsmanship, perfect for elegant interiors.", 55000 , 55000, "img/arm_chair.jpg", LocalDateTime.now().plusHours(5)));
