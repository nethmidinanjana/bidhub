...
public class InitServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        auctionManager.addAuctionItem(new AuctionItem("2", "Vintage Rolex Watch", "A timeless classic from Rolex, this vintage watch showcases elegant craftsmanship and enduring style. Perfect for collectors or those who appreciate luxury heritage.", 350000, 350000, "img/watch.jpg", LocalDateTime.now().plusMinutes(3)));
